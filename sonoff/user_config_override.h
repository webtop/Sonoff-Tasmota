...
// -- Project -------------------------------------
#define PROJECT                "hci"             // PROJECT is used as the default topic delimiter and OTA file name
...
#define STA_SSID1              "ALLSOPP-2-4G"    // [Ssid1] Wifi SSID
#define STA_PASS1              "QnQbB8000$1"     // [Password1] Wifi password
...
#else
  #define MQTT_HOST            "office-server.local" // [MqttHost]
...
#define USE_WEBSERVER                            // Enable web server and wifi manager (+66k code, +8k mem) - Disable by //
  ...
  #define WEB_PASSWORD         "QnQbB8000$1"     // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
  #define FRIENDLY_NAME        "HCI"             // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
